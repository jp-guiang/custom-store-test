// Hardcoded products for testing (no database required)
// When database is ready, we'll switch to embedded Medusa Product Module
...
// Usage:
// - Products are hardcoded for testing (no database needed)
// - When database is ready, uncomment Medusa module code above
// - All 5 products are returned immediately
